...
export const HANDBOOK_SECTIONS: SectionMeta[] = [
    ...
    { type: 'Background Knowledge', label: '背景知识', labelEn: 'Background Knowledge', icon: 'Lightbulb', min: 0, max: 5, default: 5 },
    { type: 'Activity/Worksheet', label: '活动/工作表', labelEn: 'Activity Page', icon: 'PenTool', min: 1, max: 10, default: 10, required: true },
    { type: 'Reading', label: '阅读页', labelEn: 'Reading', icon: 'BookOpen', min: 0, max: 5, default: 5 },
...
export const HANDBOOK_PRESETS: Record<string, HandbookPreset> = {
    light: {
        ...
        sections: {
            'Cover': 1, 'Safety': 1, 'Background Knowledge': 1,
            'Activity/Worksheet': 3, 'Reading': 1, 'Reflection': 1,
    ...
    standard: {
        ...
        sections: {
            ...
            'Background Knowledge': 2, 'Activity/Worksheet': 4, 'Reading': 2,
    ...
    full: {
        ...
        sections: {
            'Cover': 1, 'Table of Contents': 1, 'Safety': 1, 'Prop Checklist': 1,
            'Background Knowledge': 3, 'Activity/Worksheet': 6, 'Reading': 3,
    ...
    deep: {
        ...
        sections: {
            ...
            'Background Knowledge': 5, 'Activity/Worksheet': 10, 'Reading': 5,
            'Reflection': 2, 'Certificate': 1, 'Back Cover': 1,
        },
    },
};
