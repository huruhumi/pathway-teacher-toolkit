            ...
            <div className="grid gap-6">
                <div className="relative">
                    ...
                    <div className="pl-6 py-2">
                        ...
                        {readOnly ? (
                            <div className="text-slate-700 dark:text-slate-400 text-sm italic leading-relaxed font-serif whitespace-pre-wrap">
                                {editableReport.teacherNote.en}
                            </div>
                        ) : (
                            <textarea
                                className="w-full text-slate-700 dark:text-slate-400 text-sm italic bg-transparent outline-none resize-none font-serif leading-relaxed focus:bg-slate-50 rounded p-2"
                                rows={3}
                ...
                <div className="relative">
                    ...
                    <div className="pl-6 py-2">
                        ...
                        {readOnly ? (
                            <div className="text-slate-700 dark:text-slate-400 text-sm leading-relaxed whitespace-pre-wrap">
                                {editableReport.teacherNote.zh}
                            </div>
                        ) : (
                            <textarea
                                className="w-full text-slate-700 dark:text-slate-400 text-sm leading-relaxed bg-transparent outline-none resize-none focus:bg-slate-50 rounded p-2"
                                rows={3}
