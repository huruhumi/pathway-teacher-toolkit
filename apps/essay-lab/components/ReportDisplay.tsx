      ...
      <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 print:shadow-none print:p-0 print:break-inside-avoid">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex items-center gap-2 print:hidden">
            {!showGolden && (
              ...
              >
                <i className={`fa-solid ${showHighlights ? 'fa-eye' : 'fa-eye-slash'}`}></i>
            ...
            >
              <i className={`fa-solid ${showGolden ? 'fa-rotate-left' : 'fa-wand-magic-sparkles'}`}></i>
        ...
        <div className="grid lg:grid-cols-3 gap-0 border border-slate-100 rounded-2xl overflow-hidden shadow-sm">
          ...
          <div className="lg:col-span-2 relative bg-white border-r border-slate-100 p-8">
            <i className="fa-solid fa-quote-left absolute top-4 left-4 text-4xl text-slate-50 -z-0 print:hidden"></i>
                  ...
                  orderedMatches.map((match) => (
                    <div key={match.id} className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                      ...
                      <div className="flex justify-center -my-2 relative z-10">
                        <i className="fa-solid fa-arrow-down text-slate-200 text-xs bg-white rounded-full p-1 border border-slate-50"></i>
                      </div>
                      ...
                      <div className="bg-slate-50 rounded-lg p-3 text-xs text-slate-600 leading-relaxed border border-slate-100 mb-2">
                        <div className="flex items-center gap-1.5 mb-1 text-slate-400 font-bold uppercase tracking-wider text-[10px]">
                          <i className="fa-solid fa-circle-info"></i> Reason
                        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 print:shadow-none print:p-0 print:break-inside-avoid">
          <h3 className="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
            <i className="fa-solid fa-chart-pie text-indigo-500 print:hidden"></i>
            句式多样性分析
          </h3>
          <div className="space-y-4">
            ...
            <div className="mt-4 p-3 bg-indigo-50 rounded-xl text-xs text-indigo-800 leading-relaxed">
              <i className="fa-solid fa-lightbulb mr-1 text-indigo-500"></i>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-slate-50/50 rounded-2xl p-6 border-l-4 border-blue-400 print:bg-white print:border-l-2 print:border-slate-300 print:p-0 print:pl-4">
            <h4 className="font-bold text-slate-800 mb-3 flex items-center gap-2">
              <i className="fa-solid fa-pen-ruler text-blue-400 text-xs print:hidden"></i>
              规范专栏
            </h4>
            {readOnly ? (
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              ...
              {!readOnly && (
                ...
                >
                  {generating === 'idiomSuggestions' ? <i className="fa-solid fa-circle-notch animate-spin text-[10px]"></i> : <i className="fa-solid fa-plus text-[10px]"></i>}
                </button>
              )}
            </div>
        ...
        <section className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 print:shadow-none print:p-0 print:break-inside-avoid">
          <div className="flex items-center justify-between mb-8">
            ...
            {!readOnly && (
              ...
              >
                {generating === 'languageEnhancement' ? <i className="fa-solid fa-circle-notch animate-spin text-xs"></i> : <i className="fa-solid fa-plus text-xs"></i>}
              </button>
            )}
          </div>
        ...
        <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 print:shadow-none print:p-0 print:border-none">
          <div className="flex items-center justify-between mb-6">
            ...
            {!readOnly && (
              ...
              >
                {generating === 'wordBank' ? <i className="fa-solid fa-circle-notch animate-spin text-xs"></i> : <i className="fa-solid fa-plus text-xs"></i>}
              </button>
            )}
          </div>
        ...
        <section className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 print:shadow-none print:p-0 print:border-none">
          <div className="flex items-center justify-between mb-6">
            ...
            {!readOnly && (
              ...
              >
                {generating === 'topicExtensions' ? <i className="fa-solid fa-circle-notch animate-spin text-xs"></i> : <i className="fa-solid fa-plus text-xs"></i>}
              </button>
            )}
          </div>
                  ...
                  {item.options.map((option, optIdx) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {option}
                        {showResult && isCorrect && <i className="fa-solid fa-check float-right mt-1 text-emerald-600"></i>}
                        {showResult && isSelected && !isCorrect && <i className="fa-solid fa-xmark float-right mt-1 text-rose-600"></i>}
                      </button>
                    )
                  })}
                </div>
