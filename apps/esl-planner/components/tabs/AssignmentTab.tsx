                        ...
                        onClick={async () => {
                            ...
                            try {
                                ...
                                const res = await ai.models.generateContent({
                                    model: 'gemini-2.5-flash',
                                    contents: `课程主题: ${topic}\n学生各维度星级: ${ratingSummary}\n随机种子: ${seed}\n\n请根据以上星级，用中文写一段老师评语（4-5句话，约80-120字）。要求：\n1. 语气亲切温暖，像一位有经验的老师手写的，绝对不要用AI常见的"在...方面表现出色"这种套话\n2. 要具体结合课程主题，提到学生在这节课中可能做了什么（比如"今天学了greeting，你主动跟同学打招呼很棒"这样的具体场景）\n3. 高星级的维度要真诚表扬，可以用"我注意到""让我印象深刻的是"等自然表达\n4. 低星级（1-2星）的维度要用鼓励性语气建议，比如"下次我们可以试试..."\n5. 如果所有维度都没打分(0分)，写一段通用的鼓励性评语，也要结合课程主题\n6. 每次生成的措辞、句式结构、开头方式都要有变化，不要千篇一律\n7. 直接输出评语文字，不要加引号、标题或任何格式标记`,
                                });
