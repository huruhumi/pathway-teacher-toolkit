...
const PHASES = [
    { key: 'authenticating', label: '验证认证', icon: BookOpenCheck },
    { key: 'creating_notebook', label: '创建笔记本', icon: BookOpenCheck },
    { key: 'uploading_sources', label: '上传资源', icon: Upload },
    { key: 'generating_slides', label: '生成 Slides', icon: Sparkles },
] as const;
                            ...
                            <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-xl">
                                ...
                                {stats && (
                                    <div className="mt-2 text-xs text-emerald-600 dark:text-emerald-300 space-y-0.5">
                                        <p>📄 Slide 内容: {stats.handbookSources} 个源</p>
